...
A Mozilla engineer introduced me to BugBug (https://github.com/mozilla/bugbug), an AI-powered tool that selects the best tests for bug coverage based on bug reports. Additionally, I learned about Cluecumber (https://github.com/trivago/cluecumber), a project by Trivago for visualizing test reports, which seems worth exploring.
