...
The [**openSUSE Conference 2025**](https://events.opensuse.org/conferences/oSC25) has just wrapped up, and although I had to participate remotely this year from the coast of Cambrils, I'm incredibly happy to have been able to contribute with my pre-recorded talk: [**"Quality on Autopilot: Scaling Testing in Uyuni"**](https://events.opensuse.org/conferences/oSC25/program/proposals/4975).

It was a fantastic opportunity to share the journey we've undertaken at SUSE to scale quality in an open-source project as dynamic and complex as [Uyuni](https://www.uyuni-project.org/). The question I tried to answer was: *How do you scale quality in a fast-moving open-source project?*
<br><br>

### What Was the Talk About? A Recap of Our Journey

For those who couldn't attend, the talk is a tour through our adoption of **TestOps** practices to bring more automation, visibility, and resilience into our Quality Engineering processes. This wasn't an overnight change, but a story of small, iterative improvements.
...
This post is just the beginning. In the coming days, I plan to write a bit more detail on some of these topics and, most importantly, share a **summary of what I've learned from other incredible talks** I was able to follow at the openSUSE Conference 2025.
